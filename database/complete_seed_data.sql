...
INSERT INTO public.profiles (id, username, full_name, avatar_url, bio, age, gender, country, city, tribe, languages, interests, relationship_intention, verification_level, is_verified, vip_tier, coins_balance) VALUES
-- Rwanda profiles
(auth_id_1, 'mukiza_2024', 'Mukiza Niyonzima', 'https://picsum.photos/seed/mukiza/200/200.jpg', 'Passionate about technology and culture. Looking for someone who shares my love for Kinyarwanda poetry and modern innovation.', 28, 'male'::gender_type, 'RW', 'Kigali', 'Tutsi', ARRAY['rw', 'en', 'fr'], ARRAY['technology', 'poetry', 'hiking', 'coffee', 'music'], 'looking_for_love'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 500),
(auth_id_2, 'umwari_kigali', 'Umwari Mukamana', 'https://picsum.photos/seed/umwari/200/200.jpg', 'Coffee enthusiast and dancer. Love exploring Kigali''s hidden gems and sharing Rwandan culture with others.', 25, 'female'::gender_type, 'RW', 'Kigali', 'Hutu', ARRAY['rw', 'en'], ARRAY['dancing', 'coffee', 'travel', 'cooking', 'art'], 'serious_only'::relationship_intention, 'premium'::verification_level, true, 'premium'::vip_tier, 1200),
(auth_id_3, 'gahigi_butare', 'Gahigi Habyarimana', 'https://picsum.photos/seed/gahigi/200/200.jpg', 'University professor passionate about education and traditional music. Seeking intellectual connection and cultural exchange.', 35, 'male'::gender_type, 'RW', 'Butare', 'Tutsi', ARRAY['rw', 'en', 'fr'], ARRAY['education', 'music', 'reading', 'teaching', 'research'], 'friends_first'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 800),

-- Kenya profiles
(auth_id_4, 'njoroge_nairobi', 'Njoroge Kamau', 'https://picsum.photos/seed/njoroge/200/200.jpg', 'Tech entrepreneur who loves Swahili literature and hiking Mount Kenya. Looking for a partner to build dreams with.', 30, 'male'::gender_type, 'KE', 'Nairobi', 'Kikuyu', ARRAY['sw', 'en'], ARRAY['technology', 'business', 'hiking', 'literature', 'innovation'], 'looking_for_love'::relationship_intention, 'premium'::verification_level, true, 'platinum'::vip_tier, 3000),
(auth_id_5, 'akisha_mombasa', 'Akisha Wanjiru', 'https://picsum.photos/seed/akisha/200/200.jpg', 'Marine biologist and beach lover. Passionate about ocean conservation and Swahili culture.', 27, 'female'::gender_type, 'KE', 'Mombasa', 'Mijikenda', ARRAY['sw', 'en'], ARRAY['ocean', 'conservation', 'swimming', 'photography', 'travel'], 'serious_only'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 600),
(auth_id_6, 'otieno_kisumu', 'Otieno Ochieng', 'https://picsum.photos/seed/otieno/200/200.jpg', 'Football coach and community leader. Love teaching kids and exploring Lake Victoria region.', 32, 'male'::gender_type, 'KE', 'Kisumu', 'Luo', ARRAY['sw', 'en', 'luo'], ARRAY['football', 'coaching', 'community', 'fishing', 'music'], 'friends_first'::relationship_intention, 'basic'::verification_level, true, 'free'::vip_tier, 300),

-- Uganda profiles
(auth_id_7, 'nakato_kampala', 'Nakato Namulondo', 'https://picsum.photos/seed/nakato/200/200.jpg', 'Fashion designer and Luganda language enthusiast. Creating modern designs with traditional Ugandan inspiration.', 26, 'female'::gender_type, 'UG', 'Kampala', 'Baganda', ARRAY['lg', 'en', 'sw'], ARRAY['fashion', 'design', 'culture', 'art', 'entrepreneurship'], 'looking_for_love'::relationship_intention, 'premium'::verification_level, true, 'premium'::vip_tier, 1500),
(auth_id_8, 'mukasa_jinja', 'Mukasa Ssebadduka', 'https://picsum.photos/seed/mukasa/200/200.jpg', 'Tour guide and storyteller. Love sharing Uganda''s history and exploring the source of the Nile.', 29, 'male'::gender_type, 'UG', 'Jinja', 'Baganda', ARRAY['lg', 'en'], ARRAY['tourism', 'history', 'storytelling', 'nature', 'adventure'], 'serious_only'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 900),
(auth_id_9, 'acholi_gulu', 'Aciro Lakot', 'https://picsum.photos/seed/aciro/200/200.jpg', 'Social worker and traditional dancer. Preserving Acholi culture while building better communities.', 31, 'female'::gender_type, 'UG', 'Gulu', 'Acholi', ARRAY['en', 'sw', 'lg'], ARRAY['social_work', 'dancing', 'culture', 'community', 'music'], 'friends_first'::relationship_intention, 'basic'::verification_level, true, 'free'::vip_tier, 400),

-- Tanzania profiles
(auth_id_10, 'mussa_dar', 'Mussa Kimario', 'https://picsum.photos/seed/mussa/200/200.jpg', 'Safari guide and wildlife photographer. Capturing Tanzania''s beauty one photo at a time.', 33, 'male'::gender_type, 'TZ', 'Dar es Salaam', 'Chaga', ARRAY['sw', 'en'], ARRAY['photography', 'wildlife', 'safari', 'travel', 'conservation'], 'looking_for_love'::relationship_intention, 'premium'::verification_level, true, 'platinum'::vip_tier, 2500),
(auth_id_11, 'zawadi_arusha', 'Zawadi Mwangi', 'https://picsum.photos/seed/zawadi/200/200.jpg', 'Mount Kilimanjaro guide and adventure seeker. Love heights and helping others reach their peaks.', 24, 'female'::gender_type, 'TZ', 'Arusha', 'Maasai', ARRAY['sw', 'en', 'ma'], ARRAY['hiking', 'adventure', 'guiding', 'nature', 'fitness'], 'serious_only'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 700),
(auth_id_12, 'khalid_zanzibar', 'Khalid Hassan', 'https://picsum.photos/seed/khalid/200/200.jpg', 'Spice merchant and historian. Sharing Zanzibar''s rich history and aromatic treasures.', 36, 'male'::gender_type, 'TZ', 'Zanzibar', 'Arab', ARRAY['sw', 'en', 'ar'], ARRAY['history', 'spices', 'trade', 'culture', 'storytelling'], 'friends_first'::relationship_intention, 'basic'::verification_level, true, 'free'::vip_tier, 350),

-- Burundi profiles
(auth_id_13, 'nizigiyimana_bujumbura', 'Nizigiyimana Barutwanayo', 'https://picsum.photos/seed/nizigiyimana/200/200.jpg', 'Journalist and drummer. Preserving Burundi''s stories through words and rhythms.', 28, 'male'::gender_type, 'BI', 'Bujumbura', 'Hutu', ARRAY['fr', 'rw', 'sw'], ARRAY['journalism', 'music', 'drumming', 'culture', 'writing'], 'looking_for_love'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 550),
(auth_id_14, 'sophie_gitega', 'Sophie Ndayisenga', 'https://picsum.photos/seed/sophie/200/200.jpg', 'Teacher and community organizer. Empowering youth through education in Kirundi and French.', 30, 'female'::gender_type, 'BI', 'Gitega', 'Tutsi', ARRAY['fr', 'rw', 'sw'], ARRAY['education', 'community', 'teaching', 'culture', 'empowerment'], 'serious_only'::relationship_intention, 'basic'::verification_level, true, 'free'::vip_tier, 280),

-- Congo profiles
(auth_id_15, 'antoine_kinshasa', 'Antoine Mbuyi', 'https://picsum.photos/seed/antoine/200/200.jpg', 'Music producer and Lingala artist. Creating beats that tell Congo''s stories.', 32, 'male'::gender_type, 'CD', 'Kinshasa', 'Kongo', ARRAY['fr', 'ln', 'sw'], ARRAY['music', 'production', 'lingala', 'dance', 'culture'], 'looking_for_love'::relationship_intention, 'premium'::verification_level, true, 'premium'::vip_tier, 1800),
(auth_id_16, 'marie_lubumbashi', 'Marie Kalonji', 'https://picsum.photos/seed/marie/200/200.jpg', 'Mining engineer and advocate. Balancing industry growth with environmental protection.', 29, 'female'::gender_type, 'CD', 'Lubumbashi', 'Luba', ARRAY['fr', 'sw', 'ln'], ARRAY['engineering', 'environment', 'advocacy', 'mining', 'innovation'], 'friends_first'::relationship_intention, 'standard'::verification_level, true, 'free'::vip_tier, 650)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.coin_transactions (user_id, amount, transaction_type, description, reference_id) VALUES
(kenya_id_1, 3000, 'purchase'::transaction_type, 'Purchased 3000 LoveX Coins', (SELECT id FROM public.subscriptions WHERE user_id = kenya_id_1 LIMIT 1)),
(rwanda_id_2, 500, 'purchase'::transaction_type, 'Purchased 500 LoveX Coins', NULL),
(kenya_id_2, 200, 'bonus'::transaction_type, 'Monthly bonus - Premium subscription', NULL),
(rwanda_id_1, -10, 'gift_sent'::transaction_type, 'Sent Rose to umwari_kigali', (SELECT id FROM public.sent_gifts WHERE from_user_id = rwanda_id_1 LIMIT 1)),
(rwanda_id_2, -20, 'gift_sent'::transaction_type, 'Sent Coffee to njoroge_nairobi', (SELECT id FROM public.sent_gifts WHERE from_user_id = rwanda_id_2 LIMIT 1)),
(kenya_id_2, 1, 'gift_received'::transaction_type, 'Received Rose from njoroge_nairobi', (SELECT id FROM public.sent_gifts WHERE to_user_id = kenya_id_2 LIMIT 1)),
(kenya_id_1, 2, 'gift_received'::transaction_type, 'Received Coffee from umwari_kigali', (SELECT id FROM public.sent_gifts WHERE to_user_id = kenya_id_1 LIMIT 1));
